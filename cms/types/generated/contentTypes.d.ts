...
export interface ApiAuditLogAuditLog extends Schema.CollectionType {
  ...
  info: {
    ...
    description: 'Track all content changes and approvals';
  };
  options: {
  ...
  attributes: {
    ...
    entityId: Attribute.String & Attribute.Required;
    entityKey: Attribute.String;
    performedBy: Attribute.Relation<'api::audit-log.audit-log', 'manyToOne', 'admin::user'>;
    ...
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::audit-log.audit-log', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::audit-log.audit-log', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiNotificationNotification extends Schema.CollectionType {
  ...
  info: {
    ...
    description: 'In-app notifications for approval workflow';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    targetUser: Attribute.Relation<'api::notification.notification', 'manyToOne', 'admin::user'>;
    targetRole: Attribute.String;
    relatedEntity: Attribute.String;
    relatedEntityId: Attribute.String;
...
export interface ApiTranslationTranslation extends Schema.CollectionType {
  ...
  info: {
    ...
    description: 'UI translations with approval workflow';
  };
  options: {
  ...
  attributes: {
    ...
    category: Attribute.Enumeration<
      ['navigation', 'homepage', 'courses', 'common', 'errors', 'forms', 'auth']
    > &
    ...
    approvalStatus: Attribute.Enumeration<
      ['draft', 'pending_review', 'under_review', 'changes_requested', 'approved', 'published']
    > &
      Attribute.DefaultTo<'draft'>;
    submittedBy: Attribute.Relation<'api::translation.translation', 'manyToOne', 'admin::user'>;
    submittedAt: Attribute.DateTime;
    reviewedBy: Attribute.Relation<'api::translation.translation', 'manyToOne', 'admin::user'>;
    reviewedAt: Attribute.DateTime;
    reviewNotes: Attribute.Text;
